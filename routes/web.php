...
Route::post('/add-files-to-queue', [ColaController::class, 'addFilesToQueue'])->name('add.files.to.queue');
Route::get('/get-files-queue', [ColaController::class, 'getFilesQueue'])->name('get.files.queue');
Route::post('/clear-files-queue', [ColaController::class, 'clearFilesQueue'])->name('clear.files.queue');
