            ...
            xhr.onload = function() {
                if (xhr.status >= 200 && xhr.status < 400) {
                    ...
                    data.reservas.forEach(function(reserva) {
                      ...
                      // Agregar el botón con el contenido dinámico
                      contenidoReserva += '<a href="/cambio" class="btn btn-dark" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="left" data-bs-content="' + nombreTrabajador + '">' + nombreTrabajador + '</a>';
