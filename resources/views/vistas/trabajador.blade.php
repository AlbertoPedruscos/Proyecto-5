...
// Obtener los parkings para la empresa con id 1
$parkings = tbl_ubicaciones::where('empresa', session('empresa'))->get();
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <button type="button" id="deseleccionarUbicaciones"
                                            class="btn btn-dark btn-sm">Deseleccionar Parkines</button>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        @foreach($parkings as $parking)
                                            <div class="form-check">
                                                <input style="background-color: grey;" class="form-check-input" type="radio" name="parking" value="{{ $parking->nombre }}" id="{{ $parking->id }}">
                                                <label class="form-check-label" for="{{ $parking->id }}">{{ $parking->nombre_sitio }}</label>
                                            </div>
                                        @endforeach
                                        </select>
                                    </div>
                ...
                if (xhr.status >= 200 && xhr.status < 400) {
                    ...
                    if (!filtroFecha || filtroFecha === fechaActual) {
                        if (inputFiltro.value == "") {
                            textonav.innerHTML = "Res. de hoy";
                            document.getElementById("texto-nav2").innerHTML = "Res. de hoy";
                        } else {
                            textonav.innerHTML = "Reservas";
                            document.getElementById("texto-nav2").innerHTML = "Reservas";
                        }
                    } else {
                        textonav.innerHTML = filtroFecha;
                        document.getElementById("texto-nav2").innerHTML = filtroFecha;
                    }
