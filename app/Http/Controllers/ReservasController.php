...
class ReservasController extends Controller
{
    ...
    public function escogerP(Request $request){
        // Obtener el valor del parking enviado desde JavaScript
        $parking = $request->input('parking');

        // Establecer la variable de sesión 'parking' con el valor recibido
        Session::put('parking', $parking);

        // Puedes devolver una respuesta al cliente si es necesario
        return "Variable de sesión 'parking' creada con éxito con el valor: " . $parking;
    }
